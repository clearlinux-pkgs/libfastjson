...
Source0  : https://github.com/rsyslog/libfastjson/archive/v0.99.9.1/libfastjson-0.99.9.1.tar.gz
...
%prep
%setup -q -n libfastjson-0.99.9.1
cd %{_builddir}/libfastjson-0.99.9.1
pushd ..
cp -a libfastjson-0.99.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680186172
